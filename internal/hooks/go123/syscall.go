...
func Syscall_FcntlFlock(fd uintptr, cmd int, lk *syscall.Flock_t) error {
	// TODO: Fix. This ought to call the Fcntl wrapped generated by gensyscall,
	// but the generated Fcntl wrapper does not take a pointer, and passing a
	// uintptr would not be safe. Need to think about that... generate another
	// wrapper? Use an alias?
	return nil
}
